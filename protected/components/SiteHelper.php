	...
	public static function getCategoryBoardmenu($n = false, $first_level = false)
	{
		$array = array(
						"Алкогольные напитки" => array (
															1=>"Granny's cocktail's special",
															2=>"TIKI COCKTAIL",
															3=>"Сухая кондитерка",
															4=>"Обидные SHOOTER",
															5=>"Безобидные SHOOTER",
															6=>"SANGAREE",
															7=>"PUNCH",
															8=>"SHRUB",
															9=>"COBBLERS",
															...
															11=>"JULEP",
															12=>"Экстрим коктейли",
															13=>"Фирменная подборка Granny",
															14=>"HOT DRINKS",
															15=>"Модные коктейли",
															16=>"Любимые коктейли Бабули",
															17=>"Коктейли-ГИГАНТЫ",
															18=>"PARTY SET",
                          33=>"Коктейли команды Grannys Bar",
														), 
						"Безалкогольные напитки" => array(
														 	19=>"MILKSHAKES",
															20=>"Безалкогольные коктейли",
															21=>"Домашние морсы и лимонады",
														 ),
						22=>"Горячие закуски",
						23=>"Холодные закуски",
						24=>"Салаты",
						...
						27=>"Паста",
						28=>"Горячие блюда",
						29=>"Блюда в горшочках",
						30=>"Сэндвичи и бургеры",
						31=>"Snack foods",
						32=>"Пицца",
					);
